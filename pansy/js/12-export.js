...
window.uploadToGitHub = async function() {
    ...
    try {
        ...
        // 1. BAKE LIVE VALUES INTO INPUTS & LAYOUTS BEFORE CLONING
        window.updateIdentity();
        window.applyCardTheme(currentType);
        window.applyAwakening(currentAwakeningMode);
        window.calcFromMin('hp');
        ...
        // 1. SCAN ALL DOM LINK, SCRIPT, & IMAGE SOURCES
        ...
        // 2. FORCE INCLUDE ESSENTIAL BASE FRAMEWORK, STAT & TYPE ASSETS
        ...
        // 3. SCAN ALL ACTIVE CATEGORY IMAGES
...
window.saveQuickEditToGitHub = async function() {
    ...
    try {
        ...
        // Safeguard identity and release dates before cloning
        window.updateIdentity();
