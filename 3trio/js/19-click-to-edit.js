...
window.unlockAdminMode = function() {
    // Admin Mode unlock is strictly for published card pages
...
// Keyboard Shortcut: Ctrl + Shift + A (ONLY WAY TO UNLOCK ADMIN MODE)
...
window.highlightCardElement = function(element) {
    ...
    // PREVENT HIGHLIGHTING ON PUBLISHED CARDS UNLESS ADMIN MODE IS ACTIVE
    if (window.IS_PUBLISHED && !window.ADMIN_MODE) return;
