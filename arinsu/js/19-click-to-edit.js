...
document.addEventListener('click', function(e) {
    ...
    if (target) {
        ...
        else if (e.target.closest('#ssr-row, #tur-row, .card-info-thumb, .card-icon, #abs-awakenings-box, .abs-awaken-row, .abs-awaken-divider')) editType = 'icons';
        ...
        case 'passive':
            ...
            sidebarSections.forEach((sec) => {
                ...
                <div class="gui-section-box mb-2">
                    ...
                    <input type="text" id="gui-sec-header-${id}" class="form-control mb-2" value="${headerVal}" oninput="updateHeader(${id}, this.value); if(window.currentCardThemeStyle === 'abs-style') window.syncToAbsLayout();">
                    ...
                    <div id="gui-sec-body-${id}" style="display: ${isCollapsed ? 'none' : 'block'};">
                        ...
                        <div class="gui-btn-grid">
                            <button type="button" class="gui-preset-btn" onclick="insertShortcut('gui-sec-text-${id}', ':up:'); document.getElementById('input-sec-${id}').value=document.getElementById('gui-sec-text-${id}').value; updateSection(${id}, document.getElementById('gui-sec-text-${id}').value); if(window.currentCardThemeStyle === 'abs-style') window.syncToAbsLayout();">↑ Up</button>
                            <button type="button" class="gui-preset-btn" onclick="insertShortcut('gui-sec-text-${id}', ':down:'); document.getElementById('input-sec-${id}').value=document.getElementById('gui-sec-text-${id}').value; updateSection(${id}, document.getElementById('gui-sec-text-${id}').value); if(window.currentCardThemeStyle === 'abs-style') window.syncToAbsLayout();">↓ Down</button>
                            <button type="button" class="gui-preset-btn" onclick="insertShortcut('gui-sec-text-${id}', ':ydown:'); document.getElementById('input-sec-${id}').value=document.getElementById('gui-sec-text-${id}').value; updateSection(${id}, document.getElementById('gui-sec-text-${id}').value); if(window.currentCardThemeStyle === 'abs-style') window.syncToAbsLayout();">↓ Y-Down</button>
                            <button type="button" class="gui-preset-btn" onclick="insertShortcut('gui-sec-text-${id}', ':once:'); document.getElementById('input-sec-${id}').value=document.getElementById('gui-sec-text-${id}').value; updateSection(${id}, document.getElementById('gui-sec-text-${id}').value); if(window.currentCardThemeStyle === 'abs-style') window.syncToAbsLayout();">! Once</button>
                            <button type="button" class="gui-preset-btn" onclick="insertShortcut('gui-sec-text-${id}', ':inf:'); document.getElementById('input-sec-${id}').value=document.getElementById('gui-sec-text-${id}').value; updateSection(${id}, document.getElementById('gui-sec-text-${id}').value); if(window.currentCardThemeStyle === 'abs-style') window.syncToAbsLayout();">∞ Inf</button>
                        </div>
                    </div>
                </div>`;
            });
