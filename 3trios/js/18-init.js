...
document.addEventListener("DOMContentLoaded", function() {
    ...
    if (!window.IS_PUBLISHED) {
        ...
        // ON PUBLISHED PAGES, SIMPLY TRIGGER THE DB SUPER ATTACK SYNC TO ENSURE CSS ANIMATIONS/MULTIPLIERS RENDER
        setTimeout(() => {
            if (window.updateDokkanDBSuperAttacks) window.updateDokkanDBSuperAttacks();
        }, 300);
    }
});